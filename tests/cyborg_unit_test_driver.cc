...
/* Adapted from cycamore_unit_test_driver.cc
 * https://github.com/cyclus/cycamore/blob/develop/tests/cycamore_unit_test_driver.cc
 */
int main(int argc, char* argv[]) {
  ...
  for (int i = 0; i < argc; i++) {
    ...
    if (arg == "--help") {
      ...
      std::cout << "\t--gtest_repeat Number of times to repeat each test" <<
                std::endl;
